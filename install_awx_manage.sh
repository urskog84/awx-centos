...
# Config inventory 
if [ -f $pwd/awx/installer/inventory/conf_done]; then
    ...
    sudo sed -i "/admin_password=/c\admin_password=$admin_passowrd" awx/installer/inventory 
    touch $pwd/awx/installer/inventory/conf_done
fi
